...
public $Aseco, $localcheck, $dedicheck, $manialink_id1, $manialink_id2;
	...
	function getManialinktext($cp, $persolocalbest, $best, $dedibestof, $persodedibest, $localrank, $dedirank, $localmaxrecs, $maxdedi, $show_dedimania) {
		...
		$xmltext .= '<label scale="0.8" posn="0 3.5 0.1" halign="center" valign="center" textsize="2" text="$ffflocal"/>';
		$xmltext .= '</frame>';

		$xmltext .= '<frame posn="'.$this->frame1_posn_x.' '.$this->frame1_posn_y.' 0.3">';
		$xmltext .= '<quad posn="0 19.1 0.3" sizen="16 4"/>';
		$xmltext .= '<label scale="0.8" posn="0 0 0.1" halign="center" valign="center" textsize="2" text="$'.$this->text_color.'me ($'.$this->rank_color.''.$localrank.''.$localmaxrecs.'$fff)"/>';
		...
		$xmltext .= '<quad posn="0 19.1 0.3" sizen="16 4"/>';
		$xmltext .= '<label scale="0.8" posn="0 0 0.1" halign="center" valign="center" textsize="2" text="$'.$this->text_color.'#1"/>';
		...
		$xmltext .= '<quad posn="0 19.1 0.3" sizen="16 4"/>';
		$xmltext .= '<label scale="0.8" posn="0 3.5 0.1" halign="center" valign="center" textsize="2" text="$fffdedi"/>';
		$xmltext .= '</frame>';
		...
		$xmltext .= '<quad posn="0 19.1 0.3" sizen="16 4"/>';
		$xmltext .= '<label scale="0.8" posn="0 0 0.1" halign="center" valign="center" textsize="2" text="$'.$this->text_color.'me ($'.$this->rank_color.''.$dedirank.''.$maxdedi.'$fff)"/>';
